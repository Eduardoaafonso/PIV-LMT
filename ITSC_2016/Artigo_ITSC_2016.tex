...
\author{Eduardo Afonso$^{1}$ and Fernando Pujaico Rivera$^{2}$ and Arthur de Miranda Neto$^{3}$% <-this % stops a space
...
\input{sections/pearson}
\input{sections/particle}


\section{SYSTEM DESCRIPTION}
\input{sections/systemdesc}

\section{ALGORITHM DESCRIPTION}
 
%DiagramaX
\input{sections/multires}
\input{sections/multires3d}
\input{sections/newroi}
