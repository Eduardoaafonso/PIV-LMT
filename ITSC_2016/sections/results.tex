The followed informations introduce the results in two cases. In the first, the algorithm make the tracking of object in 2D giving informations about its 
...
\begin{figure}[H]
\centering
  \subfloat[]{\label{subfig:(a)} \includegraphics[width=.5\columnwidth]{images/images/0000000000.png}}
  \subfloat[]{\label{subfig:(b)} \includegraphics[width=.5\columnwidth]{images/images/img_paper_certa.eps}}
...
\begin{figure}[H]
\centering
  \subfloat[]{\label{subfig:(a)} \includegraphics[width=.5\columnwidth]{images/images/351.jpg}}
  \subfloat[]{\label{subfig:(b)} \includegraphics[width=.5\columnwidth]{images/images/450.jpg}}
...
The graphic of factor per frames could be seen how position per time, because the factor describes the position relative target and the amount of 
