...
then the target in the analyzed region was to a distance of $\alpha d_0$ (or $\sqrt{f_a} d_0$),
if the $i-th$ image was analyzed, thus $\alpha_i$ and $d_i=\alpha_i d_0$ will be obtained.
