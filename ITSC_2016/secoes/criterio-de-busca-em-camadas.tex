...
A Figura \ref{fig:multires}(a) mostra a aplicação em duas dimensões, onde as regiões de analises da $WOS$
são comparadas com o $ROI$. 

A Figura \ref{fig:multires}(b) representa uma aplicação em 3 dimensões, considerando a profundidade
...
O algoritmo \ref{alg:multires} descreve o método na Figura \ref{fig:multires}(b), o qual
