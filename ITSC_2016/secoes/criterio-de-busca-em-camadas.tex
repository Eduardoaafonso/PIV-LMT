...
compara imagens do mesmo tamanho. Desta maneira, o $WOS$ é redimensionado proporcionalmente ao 
tamanho do $ROI$.

A Fig. \ref{fig:multires}(a) mostra a aplicação em duas dimensiões, onde as subjanelas dos $WOS$
são analisadas com o $ROI$. 

A Fig. \ref{fig:multires}(b) representa uma aplicação em 3 dimensões, considerando a profundidade
da imagem. Neste ponto, inclui-se as camadas, estas consistem na diminuição e aumento do $ROI$ os quais 
...
\centering
  \subfloat[]{\label{subfig:(a)} \includegraphics[width=.5\columnwidth]{images/figure2a.eps}}
  \subfloat[]{\label{subfig:(b)} \includegraphics[width=.5\columnwidth]{images/figure2b.eps}}
  \caption{Os retângulos vermelhos mostram as regiões analisadas e o retângulo preto represeta o $WOS$. 
...
\begin{algorithm}
 \KwData{$ROI$, posição $P_0$, fator de aproximação $\alpha$, braço de busca 
 $L$ e frame $I_i$. }
