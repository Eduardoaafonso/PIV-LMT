...
\begin{algorithm}
 ...
 fator de aproximação $\alpha$ relativa à distância $d_{ROI}$, o valor $L$ que representa a distância do braço de busca 
 e a imagem $I_i$. }
 \KwResult{A matriz de correlação $A$, com o resultado de calcula o $CCP$ com as 
regiões de analise selecionadas ao redor do ponto $P_{i-1}$ na imagem $I_i$. }
 ~\\
 $W$: Width of $ROI$\;
 $H$: Height of $ROI$\;
