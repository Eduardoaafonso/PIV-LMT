...
da posição do objeto em 2D, $(x, y, d)$, sendo $x$ e $y$ as posições 
...
O algoritmo \ref{alg:system} recebe como entradas, a posição inicial $(x_0, y_0, d_0)$
da $ROI$ (que contem o objeto de interesse)  
e uma sequência de $N$ imagens; o processo retorna 
uma estrutura chamada $PATH$ com a posição do objeto em cada imagem, sendo que a saída $PATH\{i\}=(x_i,y_i,d_i)$
a posição da $ROI$ na imagem $I_i$.
