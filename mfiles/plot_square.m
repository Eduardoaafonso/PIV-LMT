function  MAIOR_ROR = plot_square(img2, match_params, c, DIR_IMAGES)
  ...
  baseFileName = sprintf('results/figure_%d.jpg',c); % Specify some particular, specific folder:
  fullFileName = fullfile(DIR_IMAGES, baseFileName) ;
  saveas(gca, fullFileName, 'jpg')
  refresh();
